...
const baseTranslations = {
  ...
  product: {
    ...
    edition: "Édition",
    rarityRating: "Indice de rareté",
    totalStock: "Stock total",
    totalProduced: "Production totale",
    keyFeatures: "Caractéristiques principales",
    certified: "Certifié",
    authentic: "100% Authentique",
    verifiedByExperts: "Vérifié par nos experts",
    freeWorldwideShipping: "Livraison mondiale gratuite",
    onOrdersOver: "Sur les commandes de plus de",
    dayReturns: "Retours sous 14 jours",
    noQuestionsAsked: "Sans questions",
    share: "Partager",
    backToSneakers: "Retour aux sneakers",
    productNotFound: "Produit introuvable",
    browseCollection: "Parcourir la collection",
    loading: "Chargement du produit",
    left: "restant",
    lastPairs: "Dernières paires",
    pairs: "paires",
    pairsEverMade: "paires jamais fabriquées",
    premiumConstruction: "Construction premium",
    releasedIn: "Sorti en",
    currentValueTrend: "Tendance de valeur actuelle",
    limitedEditionRelease: "Sortie en édition limitée",
    adding: "Ajout en cours",
    pleaseSelectSize: "Veuillez sélectionner une taille",
    onlyItemsAvailable: "Seulement {{count}} articles disponibles dans cette taille"
  },
  pages: {
    home: {
